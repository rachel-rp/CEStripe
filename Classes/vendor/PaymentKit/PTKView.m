...
- (void)setup
{
    ...
    backgroundImageView.image = [[UIImage imageNamed:@"modules/co.coolelephant.stripe/textfield"]
    ...
    gradientImageView.image = [UIImage imageNamed:@"modules/co.coolelephant.stripe/gradient"];
...
- (void)setupPlaceholderView
{
    ...
    self.placeholderView.image = [UIImage imageNamed:@"modules/co.coolelephant.stripe/placeholder"];
...
- (void)setPlaceholderToCVC
{
    ...
    if (cardType == PTKCardTypeAmex) {
        [self setPlaceholderViewImage:[UIImage imageNamed:@"modules/co.coolelephant.stripe/cvc-amex"]];
    } else {
        [self setPlaceholderViewImage:[UIImage imageNamed:@"modules/co.coolelephant.stripe/cvc"]];
    }
}
...
- (void)setPlaceholderToCardType
{
    ...
    [self setPlaceholderViewImage:[UIImage imageNamed:[NSString stringWithFormat:@"modules/co.coolelephant.stripe/%@",cardTypeName]]];
}
